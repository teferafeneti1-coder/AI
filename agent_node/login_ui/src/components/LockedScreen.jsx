...
function Row({ label, value }) {
  return (
    <div style={{ display: 'flex', justifyContent: 'space-between', padding: '0.5rem 0', borderBottom: '1px solid #21262d' }}>
...
const s = {
  ...
  card: { background: '#161b22', border: '1px solid #b91c1c', borderRadius: '14px', padding: '2.5rem', width: '100%', maxWidth: '420px', textAlign: 'center' },
  ...
  code: { background: '#21262d', padding: '0.15rem 0.4rem', borderRadius: '4px', fontFamily: 'monospace', color: '#79c0ff' },
  infoBox: { background: '#0d1117', border: '1px solid #21262d', borderRadius: '8px', padding: '0.25rem 1rem', marginBottom: '1.25rem', textAlign: 'left' },
  note: { fontSize: '0.82rem', color: '#79c0ff', lineHeight: '1.4', padding: '0.65rem 0.75rem', background: '#1f3038', border: '1px solid #1f6feb', borderRadius: '6px', marginBottom: '1.5rem' },
  btn: { background: '#238636', border: 'none', borderRadius: '7px', padding: '0.75rem', fontSize: '0.95rem', fontWeight: '600', color: '#fff', cursor: 'pointer', width: '100%' },
}
